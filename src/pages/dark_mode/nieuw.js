...
import styles from '@/styles/dark_mode/nieuw.module.css';
...
export default function FeelingsPage() {
    ...
    const handleSubmit = () => {
        ...
        router.push('/dark_mode/statistieken');
    };
    ...
    const steps = [
        {
            ...
            content: (
                <div className={styles.colorsContainer}>
                    {[
                        { color: '#51BCFE', label: 'Somber', svg: '/vormen/somber.svg' },
                        { color: '#B97C96', label: 'Ontspannen', svg: '/vormen/ontspannen.svg' },
                        { color: '#FE5351', label: 'Geïrriteerd', svg: '/vormen/geïrriteerd.svg' },
                        { color: '#FEBA51', label: 'Vrolijk', svg: '/vormen/vrolijk.svg' },
                    ].map(({ color, label, svg }) => (
                        <button
                            key={color}
