...
export default function Footer() {
  ...
  return (
    <footer className={styles.footer}>
      ...
      <Link href="/light_mode/home" passHref className={`${styles.footerLink} ${activeIcon === 'home' && styles.active}`} onClick={() => handleIconClick('home')}>
  <Image src={activeIcon === 'home' ? "/home-active.svg" : "/home.svg"} alt="Home" className={styles.footerIcon} width={300} height={40}/>
</Link>
<Link href="/light_mode/connecties" passHref className={`${styles.footerLink} ${activeIcon === 'zoeken' && styles.active}`} onClick={() => handleIconClick('connecties')}>
...
<Link href="/light_mode/nieuw" passHref className={`${styles.footerLink} ${activeIcon === 'nieuw' && styles.active}`} onClick={() => handleIconClick('nieuw')}>
  <Image src={activeIcon === 'nieuw' ? "/nieuw-active.svg" : "/nieuw.svg"} alt="nieuw" className={styles.footerIcon} width={300} height={40}/>
</Link>
<Link href="/light_mode/statistieken" passHref className={`${styles.footerLink} ${activeIcon === 'statistieken' && styles.active}`} onClick={() => handleIconClick('statistieken')}>
...
<Link href="/light_mode/profiel" passHref className={`${styles.footerLink} ${activeIcon === 'profiel' && styles.active}`} onClick={() => handleIconClick('profiel')}>
